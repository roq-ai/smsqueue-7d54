...
import { getPhoneNumberById } from 'apiSdk/phone-numbers';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Phone Number Detail View
          </Text>
          {hasAccess('phone_number', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/phone-numbers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
